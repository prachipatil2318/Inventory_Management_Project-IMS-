...
class employeeClass:
    def __init__(self,root):
        ...
        cmb_search=ttk.Combobox(searchFrame,textvariable=self.var_searchby,values=("Name","Contact"),state='readonly',justify=CENTER,font=("goudy old style",15))
        cmb_search.place(x=10,y=10,width=180)
        cmb_search.current(0)

        txt_search=Entry(searchFrame,textvariable=self.var_searchtxt,font=("goudy old style",15),bg="lightyellow").place(x=200,y=10)
        btn_search=Button(searchFrame,text="search",command=self.select,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=410,y=9,width=150,height=30)
        ...
        cmb_gender = ttk.Combobox(self.root, textvariable=self.var_gender,values=("Male","Female"),state='readonly',justify=CENTER,font=("goudy old style", 15))
        ...
        # lbl_utype = Entry(self.root, textvariable=self.var_utype, font=("goudy old style", 15), bg="lightyellow").place(x=850, y=190, width=180)
        ...
        self.EmployeeTable.heading("eid",text="E-ID")
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="" :
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This ID is already used",parent=self.root)
                else:
